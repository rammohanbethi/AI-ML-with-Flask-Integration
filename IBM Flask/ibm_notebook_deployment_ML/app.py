...
def y_predict():
    ...
    payload_scoring = {"input_data": [ {"field": [["Pregnancies","Glucose","BloodPressure","SkinThickness","Insulin","BMI","DiabetesPedigreeFunction","Age"]],
                   "values": t}]}
    response_scoring = requests.post('https://eu-gb.ml.cloud.ibm.com/ml/v4/deployments/ccfb2091-8817-4465-8677-49d782180874/predictions?version=2021-02-09', json=payload_scoring, headers={'Authorization': 'Bearer ' + mltoken})
